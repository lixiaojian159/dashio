...
* @Last Modified time: 2018-10-25 15:59:39
  ...
  <div id="sidebar" class="nav-collapse ">
	...
	<div class="row">
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="/Public/admin/img/ui-danro.jpg" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img src="/Public/admin/img/ui-zac.jpg" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <img src="/Public/admin/img/product.jpg" width="200" alt="">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img src="/Public/admin/img/friends/fr-06.jpg" class="img-circle" width="80">
                      <h4>DJ SHERMAN</h4>
                    </div>
                  </div>
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="/Public/admin/img/ui-divya.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="/Public/admin/img/ui-sherman.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="/Public/admin/img/ui-danro.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="/Public/admin/img/ui-zac.jpg" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        image: '/Public/admin/img/ui-sam.jpg',
